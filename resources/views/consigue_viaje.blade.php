            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea class="form-control space-bottom" rows="6" placeholder="Textarea"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-offset-5">
                        <a href="#" class="btn btn-light waves-effect waves-light btn-circle"><i class="fa fa-search"></i></a>
                    </div>
