            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" ng-model="viaje.nombre"
                               placeholder="Nombre">
                    </div>

                    <div class="col-md-4">
                        <h5 class="text-light">Correo</h5>
                        <input type="text" class="form-control" ng-model="viaje.correo"
                               placeholder="Correo">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-offset-5">
                        <a ng-click="conseguirViaje()" class="btn btn-default btn-rounded waves-effect waves-light btn-divided btn-icon-left" style="background: white;color: black;">
